...
MulticlassPerceptron2.fit!(percep2, X_train, y_train, 1, 0.0001)
MulticlassPerceptron3.fit!(percep3, X_train, y_train, 1, 0.0001)
MulticlassPerceptron4.fit!(percep4, X_train, y_train, 1, 0.0001)
MulticlassPerceptron5.fit!(percep5, X_train, y_train, 1, 0.0001)

@time MulticlassPerceptron.fit!(percep1, X_train, y_train, 1, 0.0001)
...
@time MulticlassPerceptron5.fit!(percep5, X_train, y_train, 1, 0.0001)
